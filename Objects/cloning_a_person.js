 ...
 * copies pointers for nested objects; since arrays are objects, the shallow
 * copy just copied the pointer to the original array to objCopy. If you're
 * wondering why this happens, you might want to review Variables as Pointers
 * section in the Introduction to JavaScript book.
 */

/**
 * Initialize a new, empty object
 * Use `Object.entries(obj)` to capture each k/v pair from the original object
 *   - an array
 * Iterate through the array of k/v pairs
 * Use the newObj[k] = v notation on each iteration to build out the new object
 */
